...
export function cmdRender(a) {
  ...
  let timeline=null,beats=[];if(a.timeline){try{timeline=validateRenderBoard(readJson(path.resolve(a.timeline)),comp==='TimelineLaunch'?'launch':comp==='TimelineTutorial'?'tutorial':'unsupported');}catch(e){die(e.message)}}
